...
# Rename the table for simiplicity purposes 
...
# Turning different spelling/captialisation variations of responses into a TRUE or FALSE conditional statement, so that we can count the number of occurrences of a particular condition 
...
- R Ladies STL recently held a workshop with the package developer of gtsummary (Daniel Sjoberg) - the workshop will be posted on the R Ladies STL Youtube channel in a few days time: https://www.youtube.com/channel/UCQ7DcXWJm3es06U7lGmBDkw 
